        ...
        <>
            <div className="flex flex-col">
                <div className="max-w-3xl px-20">
                    <h2 className="font-medium underline text-2xl text-center mb-10 font-sans">Request Details</h2>
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="font-bold h-6 mt-3 text-sm leading-8 uppercase"> Request for <span className="text-red-600 font-bold text-lg">*</span></div>
                        <input
                        ...
                        <div className="font-bold h-6 mt-3 text-sm leading-8 uppercase"> Priority <span className="text-red-600 font-bold text-lg">*</span></div>
                        <select
